...
public class ArticleAdapter extends RecyclerView.Adapter<ArticleAdapter.VH> {
    ...
    /** Full-featured constructor — enables live like counts and comment preview (Headlines feed). */
    public ArticleAdapter(List<Article> data, OnItemClickListener listener,
    ...
    public void onBindViewHolder(@NonNull VH h, int position) {
        ...
        // Author row
        String initial = (a.author != null && !a.author.isEmpty())
                ? String.valueOf(a.author.charAt(0)).toUpperCase() : "农";
        ...
        if (a.coverUri != null) {
            ...
            switch (a.id) {
                case 1: h.ivThumb.setImageResource(R.mipmap.text1); break;
                case 2: h.ivThumb.setImageResource(R.mipmap.text2); break;
                case 3: h.ivThumb.setImageResource(R.mipmap.text3); break;
                case 4: h.ivThumb.setImageResource(R.mipmap.text4); break;
                default:
        ...
        if (dm != null && currentUser != null) {
            bindSocialRow(h, a);
        } else {
            // Minimal mode: hide counts + preview
    ...
    private void bindSocialRow(VH h, Article a) {
        ...
        if (top != null) {
            h.tvTopCommentUsername.setText(top.username);
    ...
    static class VH extends RecyclerView.ViewHolder {
        TextView     tvAuthorInitial, tvAuthor, tvTime, tvReadCount, tvArticleTitle;
        TextView     tvItemLikeCount, tvItemCommentCount;
        TextView     tvTopCommentUsername, tvTopCommentContent;
        ImageView    ivThumb, ivItemLikeIcon;
